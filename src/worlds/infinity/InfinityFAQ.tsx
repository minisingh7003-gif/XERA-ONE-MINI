        ...
        >
          {faqs.map((faq) => (
            <motion.div
              ...
              style={{
                border: `1px solid ${openFaq === faq.id ? 'rgba(57, 255, 136, 0.4)' : 'rgba(255,255,255,0.1)'}`,
                background: openFaq === faq.id ? 'rgba(57, 255, 136, 0.05)' : 'rgba(255,255,255,0.02)',
              }}
            >
              <button
              ...
              >
                ...
                >
                  <ChevronDown className="w-5 h-5" style={{ color: '#39FF88' }} />
                </motion.div>
              </button>
