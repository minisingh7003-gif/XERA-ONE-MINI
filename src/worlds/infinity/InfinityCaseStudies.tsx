...
interface InfinityCaseStudiesProps {
  sectionTitle: string;
  headline: string;
  description: string;
  studies: CaseStudy[];
...
export function InfinityCaseStudies({
  sectionTitle,
  headline,
  description,
  studies,
}: InfinityCaseStudiesProps) {
  const [activeStudy, setActiveStudy] = useState(0);

  return (
    <section id="case-studies" className="relative py-32 bg-black">
        ...
        <div className="flex overflow-x-auto gap-4 pb-6 mb-12 scrollbar-hide">
          {studies.map((study, index) => (
            <motion.button
              ...
              style={{
                background: activeStudy === index ? 'rgba(57, 255, 136, 0.15)' : 'rgba(255,255,255,0.02)',
                border: activeStudy === index ? '1px solid rgba(57, 255, 136, 0.5)' : '1px solid rgba(255,255,255,0.1)',
                color: activeStudy === index ? '#39FF88' : 'rgba(255,255,255,0.7)',
              }}
            >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm mb-6" style={{ color: '#39FF88' }}>{studies[activeStudy].client}</p>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {studies[activeStudy].results.map((result) => (
                  ...
                  >
                    <div className="text-2xl font-bold mb-1" style={{ color: '#39FF88' }}>{result.value}</div>
              ...
              {studies[activeStudy].testimonial && (
                ...
                >
                  ...
                  <div className="text-sm text-white/50">
                    ...
                    <span style={{ color: '#39FF88' }}>{studies[activeStudy].testimonial?.role}</span>
                  </div>
                </div>
              )}
            </div>
...
export default InfinityCaseStudies;
