...
import { Globe, BarChart3, DollarSign, TrendingUp } from 'lucide-react';
          ...
          >
            ...
            >
              {highlights.map((highlight) => {
                const IconComponent = iconComponents[highlight.icon as keyof typeof iconComponents] || Globe;
                return (
                  <motion.div
                    key={highlight.id}
                    variants={staggerItem}
          ...
          >
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
              ...
              <motion.div
                ...
                style={{ border: '2px solid rgba(0, 191, 255, 0.3)' }}
              />
              <motion.div
            ...
            >
              <span className="text-sm font-mono" style={{ color: '#00BFFF' }}>+500M views/day</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
